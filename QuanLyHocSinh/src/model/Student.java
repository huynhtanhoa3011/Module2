...
public class Student {
    ...
    public Student(String name, int id, double oralTest, double test15, double test45, double semesterTest) {
        this.name = name;
        this.id = id;
...
//        id = ++count;
    ...
    public Student(int id, String name, Double oralTest, Double test15, Double test45, Double semesterTest) {
    }
...
//        System.out.printf("\n\t\t%-26s %-12d %-14.1f %-14.1f %-14.1f %-14.1f %-14.1f", name, id, oralTest, Test15, Test45, semesterTest,this.getMediumTest());
    ...
    public String toString() {
        return String.format("\n\t\t%-26s %-12d %-18.1f %-14.1f %-14.1f %-13.1f %-14.1f", name, id, oralTest, Test15, Test45, semesterTest,this.getMediumTest());
    }
}
